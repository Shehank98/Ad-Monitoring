...
urlpatterns = [
    ...
    path('schedules/template/upload/',          views.schedule_template_upload,   name='schedule_template_upload'),
    path('schedules/template/download/',        views.schedule_template_download, name='schedule_template_download'),
    ...
    path('brand-mappings/quick/delete/', views.brand_mapping_quick_delete, name='brand_mapping_quick_delete'),
